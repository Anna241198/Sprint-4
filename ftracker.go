...
func ShowTrainingInfo(action int, trainingType string, duration, weight, height float64, lengthPool, countPool int) string {
	...
	case trainingType == "Бег":
		distance := distance()             // вызовите здесь необходимую функцию
		speed := meanSpeed()               // вызовите здесь необходимую функцию
		calories := RunningSpentCalories() // вызовите здесь необходимую функцию
	...
	case trainingType == "Плавание":
		distance := distance()              // вызовите здесь необходимую функцию
		speed := swimmingMeanSpeed()        // вызовите здесь необходимую функцию
...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	run := ((runningCaloriesMeanSpeedMultiplier * meanSpeed() * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return run
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	walk := (walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeedInMsec, 2/height)*walkingSpeedHeightMultiplier)*duration*minInH)
	return walk
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	swimm := ((swimmingMeanSpeed(kmhInMsec)) + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * duration
	return swimm
}
